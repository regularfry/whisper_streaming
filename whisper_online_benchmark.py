...
parser.add_argument("--experiment-file", type=str, dest="experiment_file")
parser.add_argument("--warmup-silence", action="store_true", default=False, dest="warmup_silence")
...
if args.experiment_file:
    EXPERIMENT_LOG = open(args.experiment_file, "a")
...
class ServerProcessor:
    ...
    def process(self):
        ...
        while True:
            ...
            time_to_first_result_ms = (now_ns() - start_time_ns) / 1000000.0
            print("Time to first result: ", time_to_first_result_ms, "ms")
            if EXPERIMENT_LOG: print(f"{time_to_first_result_ms}ms", file=EXPERIMENT_LOG)
            break
            try:
                self.send_result(o)
